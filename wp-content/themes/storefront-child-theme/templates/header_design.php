            ...
            <div class="user_log">
                ...
                <a href="<?php echo site_url() . "/my-account" ?>">
                    <img style="display: inline-block;vertical-align: middle;"
                         src="<?php echo UD_ASSETS_PATH . 'icons/home.svg'; ?>">
                </a>
                <span class="tooltip_custom tool_tip tip_top">Dashboard home</span>
            </div>
            <div class="nav_menu_right menu_button_mobile">
                <!--                     <span class="dashicons dashicons-ellipsis"></span> -->
                <svg style="display:block;vertical-align:middle" class="main_menu_nav-btn" viewBox="0 0 512 512"
                     height="50" width="50" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M328 256c0 39.8-32.2 72-72 72s-72-32.2-72-72 32.2-72 72-72 72 32.2 72 72zm104-72c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72zm-352 0c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72z"></path>
                </svg>
                <div class="main_menu_nav">
                    <?php foreach ($primaryNav as $menu_item) { ?>
                        <a class="tool_nav_link"
    ...
    <div class="my_account_sec_2">
        <ul class="my_account_menu">
            <li class="my_account_link active_menu" data-tab="dashboard">
                <a class="<?php if ($_GET['tab'] == "dashboard") echo 'active_menu_item' ?> "
                   href="<?php echo get_account_pageUrl('dashboard') ?>">Dashboard</a>
            </li>
            <li class="my_account_link active_menu" data-tab="metadata">
                <a class="<?php if ($_GET['tab'] == "metadata") echo 'active_menu_item' ?> "
                   href="<?php echo get_account_pageUrl('metadata') ?>">Metadata</a>
            </li>
    ...
    (function ($) {
        ...
        if (isMobile) {
            $("#masthead  .menu_button_mobile").click(function () {
                const content = $(".custom_my_account_main_div .outer_wrapper_myaccount .content_left_myaccount_main");
                if ($("#masthead  .menu_button_mobile").hasClass("active")) {
                    content.animate({left: '-800px'}, 500);
            ...
            $(document).on("click", ".toggle_sidebar_button_icon", function () {
                const container = $('.outer_wrapper_myaccount');
                container.toggleClass('sidebar-hide');
            })
        }
...
<style>
    .outer_wrapper_myaccount.sidebar-hide .content_left_myaccount_main {
        justify-content: flex-start !important;
        width: auto !important;
    }

    .outer_wrapper_myaccount.sidebar-hide .content_left_myaccount_main ul li a {
        display: none !important;
    }

    .outer_wrapper_myaccount.sidebar-hide .toggle_sidebar_button_icon {
        background-color: #fff;
    }

    .outer_wrapper_myaccount.sidebar-hide .toggle_sidebar_button_icon:hover {
        background-color: #F8F6F4;
    }

    .outer_wrapper_myaccount.sidebar-hide .toggle_sidebar_button_icon svg {
        transform: rotate(180deg);
    }

    .outer_wrapper_myaccount.sidebar-hide .toggle_sidebar_button_text-text,
    .outer_wrapper_myaccount.sidebar-hide .content_left_heading_myaccount {
        display: none;
    }

    .outer_wrapper_myaccount.sidebar-hide .left_content_link {
        margin-bottom: 10px;
    }

    .content_left_footer_myaccount {
        transition: none !important;
        text-decoration: none !important;
    }

    .custom_my_account_main_div .outer_wrapper_myaccount.sidebar-hide .content_left_myaccount_main .content_left_footer_myaccount {
        width: 35px;
        overflow: hidden;
        letter-spacing: 20px;
    }
